...
BdVir & 18.3\% & 1.77 & 0.0\% & 3 &3 \\ 
\end{tabular}
\vspace{2em}
\begin{itemize}[-]
\setlength{\itemsep}{0pt}
\item BdVir .. \texttt{\footnotesize vcf/BdVirus.vcf.gz}
\end{itemize}\end{minipage}}


% Ts/Tv by sample
%
\hslide{Ts/Tv by sample}{\vbox{\centerline{\includegraphics[type=pdf,ext=.pdf,read=.pdf,height=7cm]{tstv_by_sample.0}}}}

% Hets vs non-ref Homs by sample
%
\hslide{Hets vs non-ref Homs by sample}{\vbox{\centerline{\includegraphics[type=pdf,ext=.pdf,read=.pdf,height=7cm]{hets_by_sample.0}}}}

% Singletons by sample {\normalsize(hets and homs)}
%
\hslide{Singletons by sample {\normalsize(hets and homs)}}{\vbox{\centerline{\includegraphics[type=pdf,ext=.pdf,read=.pdf,height=7cm]{singletons_by_sample.0}}}}

% Average depth by sample
%
\hslide{Average depth by sample}{\vbox{\centerline{\includegraphics[type=pdf,ext=.pdf,read=.pdf,height=7cm]{dp_by_sample.0}}}}

% Number of SNPs by sample
%
\hslide{Number of SNPs by sample}{\vbox{\centerline{\includegraphics[type=pdf,ext=.pdf,read=.pdf,height=7cm]{snps_by_sample.0}}}}

% Number of indels by sample
%
\hslide{Number of indels by sample}{\vbox{\centerline{\includegraphics[type=pdf,ext=.pdf,read=.pdf,height=7cm]{indels_by_sample.0}}}}
